...
class CreateAReceivebillsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('a_receivebills');
        Schema::create('a_receivebills', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('date')->unsigned()->nullable()->comment('收款日期');
            $table->decimal('discount', 23,3)->comment('折扣优惠');
